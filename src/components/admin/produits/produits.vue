                ...
                <BTbody>
                  <BTr v-for="product in paginatedItems" :key="product.id" class="product">
                    ...
                    <li data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Edit">
                      <div  @click="UpdateUser(product.id)" class="btn btn-sm btn-info"><i class="mdi mdi-pencil-outline"></i></div>
                    </li>
                    <li data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Delete">
                      <div @click="confirmDelete(product.id)" data-bs-toggle="modal" class="btn btn-sm btn-danger"><i class="mdi mdi-delete-outline"></i></div>
                    </li>
