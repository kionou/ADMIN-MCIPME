                    ...
                    <div class="p-2">
                      <BForm class="form-horizontal">
                        <div class="user-thumb text-center mb-4">
                          Entrez votre adresse e-mail et des instructions vous
                          seront envoyées !
                        </div>
                        ...
                        <BRow class="mb-0">
                          <BCol cols="12" class="text-end">
                            <div class="boutton">
                              <button class="" @click="PasswordOtp()">
                                Réinitialiser
                              </button>
                            </div>
                          </BCol>
                  ...
                  <BCardBody class="pt-0">
                    ...
                    <div class="p-2">
                      <BForm class="form-horizontal">
                        ...
                        <BRow class="mb-0">
                          <div class="boutton">
                            <button class="" @click="HamdleOtpPassword()">
                              Valider
                            </button>
                          </div>
                          <BCol cols="12">
  ...
  methods: {
    ...
    async renew() {
      ...
      try {
        ...
        console.error(
          "Erreur lors de la demande de renvoi du code par e-mail :",
          error
        );
      }
    },
