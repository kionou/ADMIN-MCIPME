<template>
    <Layout>
      ...
      <PageHeader title="Demandes de mise sur le marche" pageTitle="Tableau de bord"  :statistic="statistic"/>
      <BRow>
        <BCol lg="12">
  ...
  import Attente from '../../components/admin/demandes/marche/attente.vue';
  import Cours from '../../components/admin/demandes/marche/enCours.vue';
  import Traiter from '../../components/admin/demandes/marche/traiter.vue';
