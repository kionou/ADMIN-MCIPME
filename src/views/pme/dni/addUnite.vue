    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
            ...
            <div class="container-fluid" style="margin-top: 48px">
              ...
              <form class="form">
                ...
                <div v-if="currentStep === 1">
                  <BCard no-body class=""
                    style=" box-shadow:none !important; border: 1px solid #c9d1d9 !important; border-radius:0 !important">
                    <BCardBody class="pt-0">
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner la région" v-model="step1.region" no-radius color="info"
                                  :options="regionOptions" :class="{ 'error-border': resultError['Region'] }"
                                  @input="resultError['Region'] = false" v-slot="{ option }" search>
                      ...
                      " @click="handleOptionClick(option)">
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                <label for="Sousprefecture">Prefecture <span class="text-danger">*</span></label>
                                <MazSelect label="Sélectionner la préfecture" v-model="step1.prefecture" no-radius
                                  color="info" :options="prefectureOptions1" v-slot="{ option }" search
                      ...
                      " @click="handleOptionPrefecture(option)">
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner la commune" v-model="step1.commune" no-radius color="info"
                                  :options="sous_prefectureOptions" @click="handleChange"
                                  :class="{ 'error-border': resultError['Commune'] }"
                                  @input="resultError['Commune'] = false" v-slot="{ option }" search
                      ...
                      " @click="handleOptionCommune(option)">
                        ...
                        <div class="content">
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                <label for="SigleMpme">Sigle entreprise </label>
                                <input type="text" name="SigleMpme" id="SigleMpme" placeholder="DNI"
                                  v-model="step1.sigle_mpme" :class="{ 'error-border': resultError['SigleMpme'] }"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                <label for="nom">Raison sociale <span class="text-danger">*</span></label>
                                <input type="text" name="nom" id="nom" placeholder="DNI" v-model="step1.nom"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner le quartier" v-model="step1.quartier" no-radius
                                  color="info" :options="QuartierOptions"
                                  :class="{ 'error-border': resultError['Quartier'] }"
                                  @input="resultError['Quartier'] = false" search :disabled="isQuartierDisabled" />
                              </div>
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="text" name="Rue" id="Rue" placeholder="12 Conakry" v-model="step1.rue"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="text" name="BoitePostale" id="BoitePostale" placeholder="1234"
                                  v-model="step1.boite_postale" :class="{ 'error-border': resultError['BoitePostale'] }"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazPhoneNumberInput v-model="step1.tel_what" show-code-on-list no-radius color="info"
                                  :ignored-countries="['AC']" defaultCountryCode="GN" @update="results = $event"
                                  :success="results?.isValid" :class="{ 'error-border': resultError['NumeroWhatsApp'] }"
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                <label for="NumeroTelephoneSecondaire">Numéro Téléphone Secondaire
                                </label>
                                <MazPhoneNumberInput v-model="step1.tel_second" show-code-on-list no-radius color="info"
                                  :ignored-countries="['AC']" defaultCountryCode="GN" @update="results = $event"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="email" name="email" id="AdresseEmail" placeholder="dniexemple@gmail.com"
                                  v-model="step1.email" :class="{ 'error-border': resultError['AdresseEmail'] }"
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="url" name="url" id="SiteWeb" placeholder="https://exemple.com"
                                  v-model="step1.url" :class="{ 'error-border': resultError['SiteWeb'] }"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect  name="StatutEntreprise" id="StatutEntreprise" placeholder="En Activité" no-radius color="info"
                                  v-model="step1.StatutEntreprise" :class="{ 'error-border': resultError['StatutEntreprise'] }"
                                  @click="resultError['StatutEntreprise'] = false"  search :options="StatutOptions" />
                              </div>
                              <small v-if="v$.step1.StatutEntreprise.$error">{{
                                v$.step1.StatutEntreprise.$errors[0].$message
                                }}</small>
                              <small v-if="resultError['StatutEntreprise']">
                                {{ resultError["StatutEntreprise"] }}
                              </small>
                            </div>
                          </div>
                  ...
                  <BCard no-body class=""
                    ...
                    <BCardBody class="pt-0">
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner Monsieur ou Madame" v-model="step2.titreDirigeant"
                                  no-radius color="info" :options="titre"
                                  :class="{ 'error-border': resultError['TitreDirigeant'] }"
                                  @input="resultError['TitreDirigeant'] = false" search />
                              </div>
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="text" name="NomDirigeant" id="NomDirigeant" placeholder="Doe"
                                  v-model="step2.nomDirigeant" :class="{ 'error-border': resultError['NomDirigeant'] }"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="text" name="PrenomDirigeant" id="PrenomDirigeant" placeholder="John"
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner Masculin ou Feminin" v-model="step2.sexeDirigeant"
                                  no-radius color="info" :options="sexes"
                                  :class="{ 'error-border': resultError['SexeDirigeant'] }"
                                  @input="resultError['SexeDirigeant'] = false" search />
                              </div>
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner votre pays" v-model="step2.paysDirigeant"
                                  :options="sortedCountryOptions" v-slot="{ option }" search no-radius color="info"
                      ...
                      ">
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner une année" v-model="step2.anneeNaissanceDirigeant"
                                  no-radius color="info" :options="yearOptions"
                                  :class="{ 'error-border': resultError['AnneeNaissanceDirigeant'] }"
                                  @input="resultError['AnneeNaissanceDirigeant'] = false" search />
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner Oui ou Non" v-model="step2.dirigeantProprietaire" no-radius
                                  color="info" :options="choix"
                                  :class="{ 'error-border': resultError['DirigeantProprietaire'] }"
                                  @input="resultError['DirigeantProprietaire'] = false" v-slot="{ option }" search>
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                <label for="TitreProprietaire">Titre Proprietaire <span
                                    class="text-danger">*</span></label>
                                <MazSelect label="Sélectionner Monsieur ou Madamed" v-model="step2.titreProprietaire"
                                  no-radius color="info" :options="titre"
                                  :class="{ 'error-border': resultError['TitreProprietaire'] }"
                                  @input="resultError['TitreProprietaire'] = false" search />
                              </div>
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="text" name="NomProprietaire" id="NomProprietaire" placeholder="Doe"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                <label for="PrenomProprietaire">Prénom Proprietaire <span
                                    class="text-danger">*</span></label>
                                <input type="text" name="PrenomProprietaire" id="PrenomProprietaire" placeholder="John"
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner Masculin ou Féminin" v-model="step2.sexeProprietaire"
                                  no-radius color="info" :options="sexes"
                                  :class="{ 'error-border': resultError['SexeProprietaire'] }"
                                  @input="resultError['SexeProprietaire'] = false" search />
                              </div>
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner votre pays" v-model="step2.paysProprietaire"
                                  :options="sortedCountryOptions" v-slot="{ option }" search no-radius color="info"
                                  option-value-key="value" option-label-key="label" option-input-value-key="value">
                                  <div class="flex items-center" style="
                        padding-top: 0.5rem;
                      ...
                      ">
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                <label for="AnneeNaissanceProprietaire">Année Naissance Proprietaire
                                </label>
                                <MazSelect label="Sélectionner une année" v-model="step2.anneeNaissanceProprietaire"
                                  no-radius color="info" :options="yearOptions"
                                  :class="{ 'error-border': resultError['AnneeNaissanceProprietaire'] }"
                                  @input="resultError['AnneeNaissanceProprietaire'] = false" search />
                              </div>
                ...
                <div v-if="currentStep === 3">
                      ...
                      <div class="form-container">
                        <div class="content">
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                <label for="AnneeCreation">Année de Création <span class="text-danger">*</span></label>
                                <MazSelect label="Sélectionner une année" v-model="step3.an_creation" no-radius
                                  color="info" :options="yearOptions"
                                  :class="{ 'error-border': resultError['AnneeCreation'] }"
                                  @click.stop="resultError['AnneeCreation'] = false" search />
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                <label for="AnneeEntreeActivite">Année d'Entrée en Activité <span
                                    class="text-danger">*</span></label>
                                <MazSelect v-model="step3.an_entre_acti" label="Sélectionner une année" no-radius
                                  color="info" :options="yearOptions"
                                  :class="{ 'error-border': resultError['AnneeEntreeActivite'] }"
                                  @input="resultError['AnneeEntreeActivite'] = false" search />
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect v-model="step3.code_st_juriq" label="Sélectionner votre statut juridique"
                                  no-radius color="info" :options="StatutJuridiqueOptions"
                                  :class="{ 'error-border': resultError['CodeStatutJuridique'] }"
                                  @input="resultError['CodeStatutJuridique'] = false" search />
                              </div>
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner votre statut juridique" v-model="step3.autr_st_juriq"
                                  no-radius color="info" :options="StatutJuridiqueOptions"
                                  :class="{ 'error-border': resultError['AutreStatutJuridique'] }"
                                  @input="resultError['AutreStatutJuridique'] = false" search />
                  ...
                  /> -->
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                <label for="PrincipalSecteurActivite">Principal Secteur d'Activite <span
                                    class="text-danger">*</span></label>
                                <MazSelect label="Sélectionner votre secteur activité" v-model="step3.prin_sect_acti"
                                  no-radius color="info" :options="SecteurActiviteOptions"
                                  :class="{ 'error-border': resultError['PrincipalSecteurActivite'] }"
                                  @input="resultError['PrincipalSecteurActivite'] = false" v-slot="{ option }" search>
                                  <div class="flex items-center" style="
                          padding-top: 0.5rem;
                          padding-bottom: 0.5rem;
                          width: 100%;
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                <label for="ListeSousSecteurActivite">Liste Sous Secteur Activite <span
                                    class="text-danger">*</span></label>
                                <MazSelect label="Sélectionner vos sous secteurs activités"
                                  v-model="step3.selectedSousSecteurs" no-radius color="info"
                                  :options="SousSecteurActiviteOptions" multiple
                                  :class="{ 'error-border': resultError['ListeSousSecteurActivite'] }"
                                  @input="resultError['ListeSousSecteurActivite'] = false"
                                  :disabled="isSousSecteurDisabled" search />
                              ...
                              <div class="col">
                                <div class="input-groupe">
                                  <label for="PaysSiegeSocial">Pays du Siège Social <span
                                      class="text-danger">*</span></label>
                                  <MazSelect label="Sélectionner votre pays" v-model="step3.PaysSiegeSocial"
                                    :options="sortedCountryOptions" v-slot="{ option }" search no-radius color="info"
                                    :class="{ 'error-border': resultError['PaysSiegeSocial'] }"
                                    @input="resultError['PaysSiegeSocial'] = false" option-value-key="value"
                                    option-label-key="label" option-input-value-key="value">
                                    <div class="flex items-center" style="
                        padding-top: 0.5rem;
                        padding-bottom: 0.5rem;
                        width: 100%;
                      ...
                      ">
                              ...
                              <div class="col">
                                <div class="input-groupe">
                                  <label for="ListeSousSecteurActivite">Quel est le type de votre entreprise ? <span
                                      class="text-danger">*</span></label>
                                  <MazSelect label="Sélectionner le type de votre entreprise" v-model="step3.types"
                                    no-radius color="info" :options="EntrepriseOptions" multiple
                                    :class="{ 'error-border': resultError['types'] }"
                                    @input="resultError['types'] = false" search />
                            ...
                            <div class="position-relative">
                              <div class="btn-list" style="position:absolute; right: -13px; top: -16px;">
                                <div class="bouttons">
                                  <div class="boutton" style=" width: 38px; z-index:1000" @click="AddformDataZones"><i
                                      class="mdi mdi-plus-circle-outline"></i>
                                  </div>
                                </div>
                              </div>
                              <div v-for="(zone, index) in step3.Zones" :key="zone.id" class="row">
                                <div class="col-11">
                                  <div class="row mb-3 mt-3 content-group position-relative">
                                    <div class="titres">
                                      <span class="nombre">
                                        {{index + 1}}
                                      </span>
                                    ...
                                    <div class="col">
                                      <div class="input-groupe">
                                        <label for="PaysSiegeSocial">Zone Industrielle <span
                                            class="text-danger">*</span></label>
                                        <MazSelect label="Sélectionner la zone industrielle" v-model="zone.CodeZone"
                                          no-radius color="info" :options="ZoneOptions"
                                          @click="clearError(index, 'CodeZone')" search />
                                      </div>
                                      <small
                                        v-if="errors.step3.Zones && errors.step3.Zones[index] && errors.step3.Zones[index].CodeZone">{{
                                        errors.step3.Zones[index].CodeZone }}</small>
                                      <small v-if="resultError['Zones']"> {{ resultError["Zones"] }} </small>
                                    </div>
  
                                    <div class="col">
                                      <div class="input-groupe">
                                        <label for="ListeSousSecteurActivite">Superficie Occuppée <span
                                            class="text-danger">*</span></label>
                                        <MazInput v-model="zone.SuperficieOccupee" no-radius type="number" color="info"
                                          placeholder="440.5" @input="clearError(index, 'SuperficieOccupee')" />
                                        <small
                                          v-if="errors.step3.Zones && errors.step3.Zones[index] && errors.step3.Zones[index].SuperficieOccupee">{{
                                          errors.step3.Zones[index].SuperficieOccupee }}</small>
                                        <small v-if="resultError['Zones']"> {{ resultError["Zones"] }} </small>
                                      </div>
                                    </div>
                                ...
                                <div class="col-1" style="position: relative">
                                  ...
                                  <button class="btn btn-sm btn-icon btn-danger btn-wave"
                                    @click.prevent="deleteRowZones(index)"
                                    style=" position:absolute !important ; top: 57px !important; background:red;">
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="text" name="NumeroNif" id="NumeroNif" placeholder="1234567890L"
                                  v-model="step3.NumeroNif" :class="{ 'error-border': resultError['NumeroNif'] }"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                <label for="DateGenerationNif">Date Generation du Numero NifNIF en cours de validité
                                </label>
                                <input type="date" name="DateGenerationNif" id="DateGenerationNif" placeholder=""
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="text" name="NumeroRccm" id="NumeroRccm" placeholder="09R09999999"
                                  v-model="step3.NumeroRccm" :class="{ 'error-border': resultError['NumeroRccm'] }"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="text" name="NumeroTva" id="NumeroTva" placeholder="exemple"
                                  v-model="step3.NumeroTva" :class="{ 'error-border': resultError['NumeroTva'] }"
                      ...
                      <div class="form-container">
                        <div class="content">
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="number" name="PersonnelPermanentFemme" id="PersonnelPermanentFemme"
                                  placeholder="21" v-model="step4.pers_per_femm"
                                  :class="{ 'error-border': resultError['PersonnelPermanentFemme'] }"
                                  @input="calculateTotalEmployees" option-value-key="value" option-label-key="label"
                                  option-input-value-key="value" />
                              </div>
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="number" name="PersonnelPermanentHomme" id="PersonnelPermanentHomme"
                                  placeholder="11" v-model="step4.pers_per_homm"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                <label for="NbreEmploye">Nombre d'employés Guinéens<span
                                    class="text-danger"></span></label>
                                <input type="number" name="NbreEmploye" id="NbreEmploye" placeholder="33"
                                  v-model="step4.NbreEmploye" disabled
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                <label for="NbreEmployeGuinneF">Nombre d'employées féminines Guinéennes</label>
                                <input type="number" name="NbreEmployeGuinneF" id="NbreEmployeGuinneF" placeholder="11"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                <label for="NbreEmployeGuinneH">Nombre d'employés masculins Guinéens</label>
                                <input type="number" name="NbreEmployeGuinneH" id="NbreEmployeGuinneH" placeholder="55"
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                <label for="PersonnelTemporaireFemme">Personnel Temporaire Femme
                                </label>
                                <input type="number" name="PersonnelTemporaireFemme" id="PersonnelTemporaireFemme"
                                  placeholder="33" v-model="step4.pers_temp_femm"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                <label for="PersonnelTemporaireHomme">Personnel Temporaire Homme
                                </label>
                                <input type="number" name="PersonnelTemporaireHomme" id="PersonnelTemporaireHomme"
                                  placeholder="44" v-model="step4.pers_temp_homm"
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="number" name="NbreActionnaireGuinneF" id="NbreActionnaireGuinneF"
                                  placeholder="11" v-model="step4.NbreActionnaireGuinneF"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="number" name="NbreActionnaireGuinneH" id="NbreActionnaireGuinneH"
                                  placeholder="55" v-model="step4.NbreActionnaireGuinneH"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="number" name="NbreActionnaireGuinne" id="NbreActionnaireGuinne"
                                  placeholder="33" disabled v-model="step4.NbreActionnaireGuinne"
                      ...
                      <div class="form-container">
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner Oui ou Non" v-model="step5.titreRepondant" no-radius
                                  color="info" :options="titre" :class="{ 'error-border': resultError['TitreRepondant'] }"
                                  @input="resultError['TitreRepondant'] = false" search />
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input v-model="step5.nomRepondant" type="text" name="NomRepondant" id="NomRepondant"
                                  placeholder="Doe" :class="{ 'error-border': resultError['NomRepondant'] }"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                <label for="FonctionRepondant">Fonction Repondant <span
                                    class="text-danger">*</span></label>
                                <input v-model="step5.fonctionRepondant" type="text" name="FonctionRepondant"
                                  id="FonctionRepondant" placeholder="Chef de service"
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                <label for="AdresseRepondant">Adresse du Repondant<span
                                    class="text-danger">*</span></label>
                                <input v-model="step5.adresseRepondant" type="text" name="AdresseRepondant"
                                  id="AdresseRepondant" placeholder="12 conakry"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input v-model="step5.villeRepondant" type="text" name="VilleRepondant"
                                  id="VilleRepondant" placeholder="conakry"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                <label for="TelephoneWhatsAppRepondant">Téléphone WhatsApp du Repondant
                                  <span class="text-danger">*</span></label>
                                <MazPhoneNumberInput v-model="step5.telephoneWhatsAppRepondant" show-code-on-list
                                  no-radius color="info" :ignored-countries="['AC']" defaultCountryCode="GN"
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner Oui ou Non" v-model="step5.contacter" no-radius
                                  color="info" :options="choix" :class="{ 'error-border': resultError['Contacter'] }"
                                  @input="resultError['Contacter'] = false" search />
                        ...
                        <div class="content">
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                <label for="ExistanceActionnaire">Existance Actionnaire <span
                                    class="text-danger">*</span></label>
                                <MazSelect label="Sélectionner Oui ou Non" v-model="step5.existanceActionnaire" no-radius
                                  color="info" :options="choix"
                                  :class="{ 'error-border': resultError['ExistanceActionnaire'] }"
                                  @input="resultError['ExistanceActionnaire'] = false" search />
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                <label for="ExistanceConseilAdministration">Existance Conseil Administration
                                  <span class="text-danger">*</span></label>
                                <MazSelect label="Sélectionner Oui ou Non" v-model="step5.existanceConseilAdministration"
                                  no-radius color="info" :options="choix" :class="{
                      'error-border': resultError['ExistanceConseilAdministration'],
                    }" @input="resultError['ExistanceConseilAdministration'] = false" search />
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input v-model="step6.lienGoogleMapMpme" type="text" name="LienGoogleMapMpme"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input v-model="step6.latitudeMpme" type="text" name="LatitudeMpme" id="LatitudeMpme"
                                  placeholder="11.3333" :class="{ 'error-border': resultError['LatitudeMpme'] }"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input v-model="step6.longitudeMpme" type="text" name="LongitudeMpme" id="LongitudeMpme"
                                  placeholder="-12.333" :class="{ 'error-border': resultError['LongitudeMpme'] }"
          ...
          <BModal v-model="AddFichier" hide-footer centered header-class="border-0" title-class="font-18" size="lg">
            <div>
                          ...
                          <BRow>
                            <BCol cols="12 text-center">
                              <div class="modalheader p-4">
                                <h5 class="text-primary">Ajouter les Fichiers</h5>
                            ...
                            <BForm class="form-horizontal">
                                  ...
                                  <div class="mb-3 position-relative">
                                    <div class="input-groupe">
                                      ...
                                      <input type="file" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx"
                                        @change="handleFileUploadNif" name="FileNif" id="FileNif" placeholder=""
                                ...
                                <BCol md="4">
                                  <div class="mb-3 position-relative">
                                    <div class="input-groupe">
                                      ...
                                      <input type="file" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx"
                                        @change="handleFileUploadRccm" name="FileRccm" id="FileRccm" placeholder=""
                                ...
                                <BCol md="4">
                                  <div class="mb-3 position-relative">
                                    <div class="input-groupe">
                                      ...
                                      <input type="file" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx"
                                        @change="handleFileUploadCertificat" name="FileCerti" id="FileCerti"
                                        placeholder="" :class="{ 'error-border': resultError['FileCerti'] }"
                              ...
                              <BRow>
                                <BCol>
                                  <div class="mb-3 position-relative">
                                    <div class="input-groupe">
                                      <label for="FileNif">Etude de faisabilité </label>
                                      <MazSelect name="EtudeFaisabilite" id="EtudeFaisabilite" placeholder="" no-radius
                                        color="info" :options="choix" search v-model="faisabilite" />
                                    </div>
                                  </div>
                                </BCol>
                                <BCol v-if="faisabilite === 'Oui'">
                                  <div class="mb-3 position-relative">
                                    <div class="input-groupe">
                                      <label for="FichierEtudeFaisabilite">Fichier d'étude faisabilite</label>
                                      <input type="file" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx"
                                        @change="handleFileUploadFichierEtudeFaisabilite" name="FichierEtudeFaisabilite"
                                        id="FichierEtudeFaisabilite" placeholder=""
                                        :class="{ 'error-border': resultError['FichierEtudeFaisabilite'] }"
                                        @input="resultError['FichierEtudeFaisabilite'] = false" />
                                ...
                                <BCol>
                                  <div class="mb-3 position-relative">
                                    <div class="input-groupe">
                                      <label for="FichierExploitation">Fichier d'xploitation</label>
                                      <input type="file" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx"
                                        @change="handleFileUploadExploitation" name="FichierExploitation" id="FichierExploitation"
                                        placeholder="" :class="{ 'error-border': resultError['FichierExploitation'] }"
                                        @input="resultError['FichierExploitation'] = false" />
                                    </div>
                                  </div>
                                </BCol>
                              </BRow>
                              ...
                              <BRow>
                                <BCol md="4">
                                  <div class="mb-3 position-relative">
                                    <div class="input-groupe">
                                      <label for="FichierImplantation">Fichier d'implantation</label>
                                      <input type="file" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx"
                                        @change="handleFileUploadImplantation" name="FichierImplantation" id="FichierImplantation" placeholder=""
                                        :class="{ 'error-border': resultError['FichierImplantation'] }"
                                        @input="resultError['FichierImplantation'] = false" />
                                    </div>
                                  </div>
                                </BCol>
                                <BCol md="4">
                                  <div class="mb-3 position-relative">
                                    <div class="input-groupe">
                                      <label for="FichierNotification">Fichier de notification</label>
                                      <input type="file" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx"
                                        @change="handleFileUploadNotification" name="FichierNotification" id="FichierNotification" placeholder=""
                                        :class="{ 'error-border': resultError['FichierNotification'] }"
                                        @input="resultError['FichierNotification'] = false" />
                                    </div>
                                  </div>
                                </BCol>
                                <BCol md="4">
                                  <div class="mb-3 position-relative">
                                    <div class="input-groupe">
                                      <label for="FichierExtension">Fichier d'extension</label>
                                      <input type="file" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx"
                                        @change="handleFileUploadExtension" name="FichierExtension" id="FichierExtension"
                                        placeholder="" :class="{ 'error-border': resultError['FichierExtension'] }"
                                        @input="resultError['FichierExtension'] = false" />
                                    </div>
                                  </div>
                                </BCol>
                              </BRow>
...
export default {
  ...
  data() {
    return {
      ...
      StatutOptions : [
        { label: "En cours installation", value: "En cours installation" },
        { label: "En Activité", value: "En Activité" },
        { label: "En Arrêt", value: "En Arrêt" },
      ],
      errors: {
        step3: { Zones: [] },
  ...
  methods: {
    clearError(index, field) {
      ...
      if (this.errors.step3.Zones[index]) {
        this.errors.step3.Zones[index][field] = null;
      }
    },
    AddformDataZones() {
      this.step3.Zones.push({ CodeZone: '', SuperficieOccupee: '', });
    },

    deleteRowZones(index) {

      if (index !== 0) {
        this.step3.Zones.splice(index, 1);
      }
    },
    ...
    createMpmeData() {
      return {
        ...
        StatutEntreprise:this.step1.StatutEntreprise,
    ...
    handleFileUploadCertificat(event) {
     ...
     handleFileUploadFichierEtudeFaisabilite(event) {
      console.log("File input change");
      const file = event.target.files[0];
      console.log("handleFileUploadFichierEtudeFaisabilite Selected file:", file);
      this.FileFaisabilite= file
    },  
    handleFileUploadExploitation(event) {
      console.log("File input change");
      const file = event.target.files[0];
      console.log("handleFileUploadExploitation Selected file:", file);
      this.FileExploitation = file
    },  
    handleFileUploadImplantation(event) {
      console.log("File input change");
      const file = event.target.files[0];
      console.log("handleFileUploadImplantation Selected file:", file);
      this.FileImplantation = file
    }, 
    handleFileUploadNotification(event) {
      console.log("File input change");
      const file = event.target.files[0];
      console.log("handleFileUploadNotification Selected file:", file);
      this.FileNotification = file
    },  
    handleFileUploadExtension(event) {
      console.log("File input change");
      const file = event.target.files[0];
      console.log("handleFileUploadExtension Selected file:", file);
    ...
    storeUserDataLocal(userData) {
      ...
      this.step1.StatutEntreprise = userData.StatutEntreprise,
    ...
    async HamdleFile() {
      ...
      formData.append("FichierEtudeFaisabilite", this.FileFaisabilite);
      formData.append("FichierExploitation", this.FileExploitation);
      formData.append("FichierImplantation", this.FileImplantation);
      formData.append("FichierNotification", this.FileNotification);
      formData.append("FichierExtension", this.FileExtension);
      ...
      try {
        ...
        if (response.data.status === "success") {
          localStorage.setItem('faisabilite',this.faisabilite)
