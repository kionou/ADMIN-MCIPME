            ...
            <div class="generastep" data-aos="zoom-out" data-aos-delay="100">
              <div class="stepper">
                ...
                <div class="stepper-item" :class="{ current: currentStep == item, success: currentStep > item }"
                  v-for="item in 6" :key="item" @click="goToStep(item)">
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="email" name="email" id="AdresseEmail" placeholder="dnipmecl@gmail.com"
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner une année" v-model="step2.an_creation" no-radius
                                  color="info" :options="yearOptions"
                                  :class="{ 'error-border': resultError['AnneeCreation'] }"
                                  @input="resultError['AnneeCreation'] = false" search />
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect v-model="step2.an_entre_acti" label="Sélectionner une année" no-radius
                                  color="info" :options="yearOptions"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect v-model="step2.code_st_juriq" label="Sélectionner votre statut juridique"
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner votre statut juridique" v-model="step2.autr_st_juriq"
                                  no-radius color="info" :options="StatutJuridiqueOptions"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                <label for="PrincipalSecteurActivite">Principal Secteur d'Activite <span
                                    class="text-danger">*</span></label>
                                <MazSelect label="Sélectionner votre secteur activité" v-model="step2.prin_sect_acti"
                                  no-radius color="info" :options="SecteurActiviteOptions"
                                  :class="{ 'error-border': resultError['PrincipalSecteurActivite'] }"
                                  @input="resultError['PrincipalSecteurActivite'] = false" search />
                              </div>
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner vos sous secteurs activités"
                                  v-model="step2.selectedSousSecteurs" no-radius color="info"
                                  :options="SousSecteurActiviteOptions" multiple
                                  :class="{ 'error-border': resultError['ListeSousSecteurActivite'] }"
                                  @input="resultError['ListeSousSecteurActivite'] = false" search />
                              ...
                              <div class="col">
                                <div class="input-groupe">
                                  <label for="PaysSiegeSocial">Pays du Siège Social <span
                                      class="text-danger">*</span></label>
                                  <MazSelect label="Sélectionner votre pays" v-model="step2.PaysSiegeSocial"
                  ...
                  <small v-if="v$.step2.distributrice.$error">{{
                    v$.step2.distributrice.$errors[0].$message
                              ...
                              <div class="col">
                                <div class="input-groupe">
                                  <label for="ListeSousSecteurActivite">Quel est le type de votre entreprise ? <span
                                      class="text-danger">*</span></label>
                                  <MazSelect label="Sélectionner le type de votre entreprise" v-model="step2.types"
                            ...
                            <div class="position-relative">
                              ...
                              <div v-for="(zone, index) in step2.Zones" :key="zone.id" class="row">
                                <div class="col-11">
                                  <div class="row mb-3 mt-3 content-group position-relative">
                                    ...
                                    <div class="col">
                                      ...
                                      <small
                                        v-if="errors.step2.Zones && errors.step2.Zones[index] && errors.step2.Zones[index].CodeZone">{{
                                        errors.step2.Zones[index].CodeZone }}</small>
                                    ...
                                    <div class="col">
                                      <div class="input-groupe">
                                        ...
                                        <small
                                          v-if="errors.step2.Zones && errors.step2.Zones[index] && errors.step2.Zones[index].SuperficieOccupee">{{
                                          errors.step2.Zones[index].SuperficieOccupee }}</small>
                                        <small v-if="resultError['Zones']"> {{ resultError["Zones"] }} </small>
                                      </div>
                                    </div>
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="text" name="NumeroNif" id="NumeroNif" placeholder="1234567890L"
                                  v-model="step2.nbre_nif" :class="{ 'error-border': resultError['NumeroNif'] }"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="text" name="NumeroRccm" id="NumeroRccm" placeholder="09R09999999"
                                  v-model="step2.nbre_rccm" :class="{ 'error-border': resultError['NumeroRccm'] }"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="text" name="NumeroTva" id="NumeroTva" placeholder="exemple"
                                  v-model="step2.NumeroTva" :class="{ 'error-border': resultError['NumeroTva'] }"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="number" name="PersonnelPermanentFemme" id="PersonnelPermanentFemme"
                                  placeholder="21" v-model="step3.pers_per_femm"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="number" name="PersonnelPermanentHomme" id="PersonnelPermanentHomme"
                                  placeholder="11" v-model="step3.pers_per_homm"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="number" name="NbreEmploye" id="NbreEmploye" placeholder="33"
                                  v-model="step3.NbreEmploye" disabled
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="number" name="PersonnelTemporaireFemme" id="PersonnelTemporaireFemme"
                                  placeholder="33" v-model="step3.pers_temp_femm"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="number" name="PersonnelTemporaireHomme" id="PersonnelTemporaireHomme"
                                  placeholder="44" v-model="step3.pers_temp_homm"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="number" name="NbreActionnaireGuinneF" id="NbreActionnaireGuinneF"
                                  placeholder="11" v-model="step3.NbreActionnaireGuinneF"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="number" name="NbreActionnaireGuinneH" id="NbreActionnaireGuinneH"
                                  placeholder="55" v-model="step3.NbreActionnaireGuinneH"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="number" name="NbreActionnaireGuinne" id="NbreActionnaireGuinne"
                                  placeholder="33" disabled v-model="step3.NbreActionnaireGuinne"
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner Monsieur ou Madame" v-model="step4.titreDirigeant"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <input type="text" name="NomDirigeant" id="NomDirigeant" placeholder="Doe"
                                  v-model="step4.nomDirigeant" :class="{ 'error-border': resultError['NomDirigeant'] }"
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner Masculin ou Feminin" v-model="step4.sexeDirigeant"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner votre pays" v-model="step4.paysDirigeant"
                                  :options="sortedCountryOptions" v-slot="{ option }" search no-radius color="info"
                        ...
                        ">
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner une année" v-model="step4.anneeNaissanceDirigeant"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                <label for="DirigeantProprietaire">Dirigeant Proprietaire <span
                                    class="text-danger">*</span></label>
                                <MazSelect label="Sélectionner Oui ou Non" v-model="step4.dirigeantProprietaire" no-radius
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                <label for="TitreProprietaire">Titre Proprietaire <span
                                    class="text-danger">*</span></label>
                                <MazSelect label="Sélectionner Monsieur ou Madamed" v-model="step4.titreProprietaire"
                                  no-radius color="info" :options="titre"
                          ...
                          <div class="row mb-3 mt-3 content-group">
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner Masculin ou Féminin" v-model="step4.sexeProprietaire"
                                  no-radius color="info" :options="sexes"
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner votre pays" v-model="step4.paysProprietaire"
                                  :options="sortedCountryOptions" v-slot="{ option }" search no-radius color="info"
                                  option-value-key="value" option-label-key="label" option-input-value-key="value">
                                  <div class="flex items-center" style="
                          padding-top: 0.5rem;
                        ...
                        ">
                            ...
                            <div class="col">
                              <div class="input-groupe">
                                ...
                                <MazSelect label="Sélectionner une année" v-model="step4.anneeNaissanceProprietaire"
                                  no-radius color="info" :options="yearOptions"
...
export default {
  ...
  async mounted() {
    ...
    const faisabilite = localStorage.getItem('faisabilite')
    if(faisabilite){
  ...
  methods: {
    clearError(index, field) {
      ...
      if (this.errors.step2.Zones[index]) {
        this.errors.step2.Zones[index][field] = null;
      }
    },
    AddformDataZones() {
      this.step2.Zones.push({ CodeZone: '', SuperficieOccupee: '', });
    },

    deleteRowZones(index) {

      if (index !== 0) {
        this.step2.Zones.splice(index, 1);
      }
    },
    ...
    async createMpmeFormData() {
      ...
      formData.append('Zones', this.step2.Zones);
      //  formData.append('SuperficieOccupee', this.step2.SuperficieOccupee);
    ...
    //     try {
    //         const CodeMpme = this.id;
    //         // const formData = createMpmeData(mpmeData); // Créez votre objet FormData ici
    ...
    handleFileUploadCertificat(event) {
      console.log("File input change");
      const file = event.target.files[0];
      console.log("handleFilehandleFileUploadCertificatUploadNif Selected file:", file);
      this.FileCerti = file
    },
    ...
    storeUserDataLocal(userData) {
      ...
      this.step2.Zones = userData.Zones;
