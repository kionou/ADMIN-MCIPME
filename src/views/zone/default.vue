<template>
  <Layout>
    ...
    <PageHeader title="Zones Industrielles" pageTitle="Tableau de bord"  :statistic="statistic"/>
    <BRow>
      <BCol lg="12">
...
import Personnel from '../../components/admin/zones/public.vue';
import Privee from '../../components/admin/zones/privee.vue';
